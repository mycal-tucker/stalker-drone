...
import threading
import cv2  # Note: I got this working by installing opencv-python, not cv2. Magic?
import time
...
class UserVision:
    ...
    # TODO: There are weird things going on with where the images are saved.
    # Right now seems to save images inside venv/Lib/pyparrot/images
...
mamboAddr = "e0:14:d0:63:3d:d0"  # From demo. The address doesn't matter if using WIFI
